Created a db for products

db.createCollection('ProductData') //-created a collection to store productsdata
...
db.ProductData.insertMany(/*the data should be here*/)
...
db.ProductData.find({id:"10"})
        ...
        //10.Delete the products which product price value are sam